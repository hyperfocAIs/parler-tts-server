...
RUN pip3.12 install --no-cache-dir flash-attn --no-build-isolation
RUN pip3.12 install --no-cache-dir --no-deps git+https://github.com/huggingface/parler-tts.git@dcaed95 
